...
import ms.entities.Dept;
import ms.repository.DeptRepository;
...
public class DeptController {
	...
	@RequestMapping(value = "/getDeptById/{deptno}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/deleteDept/{deptno}", method = RequestMethod.DELETE)
